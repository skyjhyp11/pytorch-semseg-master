...
def test(args):
    ...
    #johnUpdate
    #img = np.array(Image.fromarray(img).resize((500, 375)))
    ...
    if args.dcrf:
        ...
        imageio.imwrite(dcrf_path, decoded_crf)
    ...
    if model_name in ["pspnet", "icnet", "icnetBN"]:
        ...
        pred = np.array(Image.fromarray(pred).resize((orig_size,)))

    decoded = loader.decode_segmap(pred)
    print("Classes found: ", np.unique(pred))
    imageio.imwrite(args.out_path, decoded)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        #john202007
        default="runs/fcn8s_coalgangue/41076/fcn8s_coalgangue_best_model.pkl",
